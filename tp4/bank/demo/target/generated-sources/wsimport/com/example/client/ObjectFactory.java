...
public class ObjectFactory {
    ...
    private final static QName _Exception_QNAME = new QName("http://ws.example.org/", "Exception");
    private final static QName _Add_QNAME = new QName("http://ws.example.org/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://ws.example.org/", "addResponse");
    private final static QName _Divide_QNAME = new QName("http://ws.example.org/", "divide");
    private final static QName _DivideResponse_QNAME = new QName("http://ws.example.org/", "divideResponse");
    private final static QName _Multiply_QNAME = new QName("http://ws.example.org/", "multiply");
    private final static QName _MultiplyResponse_QNAME = new QName("http://ws.example.org/", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("http://ws.example.org/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://ws.example.org/", "subtractResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "Exception")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "add")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "addResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "divide")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "divideResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "multiply")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "multiplyResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "subtract")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.example.org/", name = "subtractResponse")
